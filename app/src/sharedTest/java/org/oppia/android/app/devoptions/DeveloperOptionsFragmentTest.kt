...
//  }
  ...
  fun testDeveloperOptions_clickAddThreeProfiles_checksThreeProfilesAreAdded() {
    launch<DeveloperOptionsTestActivity>(
      ...
      val actualIntent = Intents.getIntents()
        .first { it.component?.className == ProfileChooserActivity::class.java.name }

      //launch(ProfileChooserActivity::class.java).use {
      launch<ProfileChooserActivity>(actualIntent).use {
        testCoroutineDispatchers.runCurrent()
    ...
    val actualIntenthome = Intents.getIntents()
      .first { it.component?.className == HomeActivity::class.java.name }

    val homeScenario =
      ActivityScenario.launch<HomeActivity>(actualIntenthome)
